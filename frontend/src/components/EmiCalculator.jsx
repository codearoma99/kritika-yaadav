...
const Calculator = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 py-8 px-4 mo-p-0">
      <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="p-8">
          <h1 className="text-4xl font-bold text-center text-indigo-800 mb-2 calc_01">Loan EMI Calculator</h1>
